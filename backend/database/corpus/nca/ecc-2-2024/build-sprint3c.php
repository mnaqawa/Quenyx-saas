...
$otBatch = [
    ...
    'reviewed_by' => null,
    'reviewed_at' => null,
    'notes' => 'Sprint 3C — OT Security (Main Domain 5) is not part of ECC-2:2024. Operational Technology Cybersecurity Controls (OTCC) is a separate publication per Appendix C. No controls to populate. Excluded from manifest.json (see excluded_domains).',
    'metadata' => [
        'curation_sprint' => '3C',

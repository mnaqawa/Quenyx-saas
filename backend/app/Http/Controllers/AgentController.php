        ...
        $instructions = [
            'linux' => [
                ...
                'steps' => [
                    ...
                    'sudo ./quenyx-agent install',
                    '# or quick hotfix without reinstall:',
                    '# id quenyx || sudo useradd --system --home-dir /var/lib/quenyx --create-home --shell /sbin/nologin quenyx',
                    '# sudo systemctl daemon-reload && sudo systemctl reset-failed quenyx-agent && sudo systemctl restart quenyx-agent',
                ],
            ],
            'windows' => [
                'title' => 'Windows',

...
function Subscriptions() {
  ...
  if (loading) {
    return <div className="text-sm text-white/60">Loading subscriptions...</div>
  }
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1 text-center">
        <h1 className="text-2xl font-semibold text-white">Module Subscriptions</h1>
        <p className="text-sm text-white/60">
          Manage your PortShield SaaS module subscriptions and access levels
        </p>
      </div>
        ...
        {modules.map((module) => (
          ...
          >
            ...
            <p className="mt-4 text-xs leading-relaxed text-white/60">
              {module.description || 'Module description is not available yet.'}
            </p>
